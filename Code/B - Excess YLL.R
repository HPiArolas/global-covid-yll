...
# Needs to be able to append well to the file out; just another column of deaths (or 3 if confidence intervals)
if(!AL){excess<-readRDS("/Users/Usuario/Dropbox/1 - A - A - Recerca/1 - Current work/COVID-19 - YLL - Shared/Data/Processed/matched_excess_deaths_delayed.rds")
}else{excess<-readRDS("Data/Processed/matched_excess_deaths_delayed.rds")}
